...
The aspect ratio of an image after [pre-processing](./croping_trimming.md)  should be 2:1. Anyway as per the layout
...
***4.*** Auto Zoom and Lock Aspect Ratio.

[Auto Zooming the room (segment)](./auto_zoom.md) when the vacuum is cleaning it. The full zoom will change the
